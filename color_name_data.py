# Adapted from ColorCompass's xkcd-derived color dictionary.
# Copyright (c) 2023 Nicolas Aguirre Campi. Distributed under the MIT License;
# see assets/licenses/ColorCompass-MIT.txt.
# ruff: noqa: F601
XKCD_COLOR_NAMES = {
