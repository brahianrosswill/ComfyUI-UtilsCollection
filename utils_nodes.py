    ...
    def define_schema(cls):
        return io.Schema(
            ...
            outputs=[
                ...
                io.String.Output("transcribed_audio", tooltip="Word-timed phrases split before uppercase words and after commas or sentence punctuation. A lone uppercase word with a comma stays with following speech until another boundary. Countable English phrases target 4–6 dictionary syllables; unknown or ambiguous counts keep text boundaries only. Phrases below one word per second are omitted as suspected hallucinations, including genuinely slow speech. Retained words appear once. Times start at the selected clip's beginning. Empty when Whisper is disconnected or no speech/audio is available, or all phrases are filtered."),
            ],
        )
